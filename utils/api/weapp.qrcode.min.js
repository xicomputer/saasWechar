...
! function (t, e) {
  ...
  var t = Object.prototype.hasOwnProperty,
    ...
    s = function t() {
      var e, r, o, s, h, l, f = arguments[0],
        g = 1,
        c = arguments.length,
        d = !1;
      for ("boolean" == typeof f && (d = f, f = arguments[1] || {}, g = 2), (null == f || "object" != typeof f && "function" != typeof f) && (f = {}); g < c; ++g)
        if (null != (e = arguments[g]))
          for (r in e) o = u(f, r), f !== (s = u(e, r)) && (d && s && (i(s) || (h = n(s))) ? (h ? (h = !1, l = o && n(o) ? o : []) : l = o && i(o) ? o : {}, a(f, {
            name: r,
            newValue: t(d, l, s)
          })) : void 0 !== s && a(f, {
            name: r,
  ...
  return A.prototype = {
      ...
      multiply: function (t) {
        for (var e = new Array(this.getLength() + t.getLength() - 1), r = 0; r < this.getLength(); r++)
          for (var o = 0; o < t.getLength(); o++) e[r + o] ^= y.gexp(y.glog(this.get(r)) + y.glog(t.get(o)));
        return new A(e, 0)
      },
      mod: function (t) {
      ...
      for (var o = r.length / 3, n = new Array, i = 0; i < o; i++)
        for (var a = r[3 * i + 0], u = r[3 * i + 1], s = r[3 * i + 2], h = 0; h < a; h++) n.push(new _(u, s));
      return n
    ...
    function (t) {
      t = t || {}, (t = s(!0, {
        ...
        var e, r = new l(t.typeNumber, t.correctLevel);
