...
Page({
    ...
    data: {
        currentStatus:'all',
        topTabList:[
            {status:'all',name:'全部',count:0},{status:0,name:'待付款',count:0},{status:1,name:'待发货',count:0},
            {status:2,name:'待收货',count:0},{status:4,name:'已完成',count:0},{status:3,name:'已退款',count:0},
        ],
    ...
    _getStateText(state,isDelete){
        ...
        switch(state){
            case 0: 
                stateText=isDelete==1?'已取消':'待付款'
                break;
            case 1: stateText='待发货';break;
            case 2: stateText='待发货';break;
