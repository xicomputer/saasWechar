/* pages/seckill/booking-list/booking-list.js */
...
Page({
    ...
    data: {
        currentStatus:0,
        topTabList:[
            {status:0,name:'待付款',count:0},{status:1,name:'待使用',count:0},
            {status:4,name:'已完成',count:0}
        ],
    ...
    showVerificationCode(e){//显示核销码
        var item=e.currentTarget.dataset.item;
        this.setData({showCodeBox:true},()=>{
            app.sjrequest('/activityOrderBusiness/queryVerification',{
                ...
                if(res.statusCode==200 && res.data.code==200){
                    ...
                    drawQrcode({
                        width: 150,height: 150,canvasId: 'myQrcode',
                        text: verification
                    })
                }
            })
